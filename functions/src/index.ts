  ...
  .https.onCall(async (data, context) => {
    ...
    try {
      ...
      const defaultQuestions = [
        ...
        'What is an important lesson your relationship has taught you?',
        'What are two dates you\'d like to go on?',
        'What are some things that keep the romance alive and healthy?',
        ...
        'What date comes to mind when you think of your favorite date together?',
        ...
        'Who are three of your heroes or inspiratinos and why?',
        ...
        'Which dish or treat has your partner make that you miss badly?',
        ...
        'What is something intimate you want to do with your partner?',
        ...
        'What is a warm childhood memory that comes to mind?',
        ...
        'What have been your three proudest moments?',
