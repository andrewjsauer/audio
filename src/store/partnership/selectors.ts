...
export const selectIsLoadingPartnerData = (state) =>
  state.partnership.isLoadingPartnerData;
export const selectIsLoadingPartnershipData = (state) =>
  state.partnership.isLoadingPartnershipData;
...
export const selectLastFailedAction = (state) =>
  state.partnership.lastFailedAction;
